...
interface AboutSectionWithImageFormProps {
  sectionKey: string;
  sectionTitle: string;
...
const AboutSectionWithImageForm: React.FC<AboutSectionWithImageFormProps> = ({
  sectionKey,
  sectionTitle,
  sectionDescription,
  formSchema,
    ...
    <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 } } }} className="h-full flex flex-col">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-full">
          ...
          <motion.div variants={formVariants} className="mt-auto">
...
export default AboutSectionWithImageForm;
